	<div class="row" id="row1-div">
	  ...
	  <ol class="carousel-indicators">
	    ...
	    <li data-target="#carousel-dino" data-slide-to="1"></li>
	    <li data-target="#carousel-dino" data-slide-to="2"></li>
	  </ol>
	  ...
	  <!-- Controls -->
	  <a class="left carousel-control" href="#carousel-dino" role="button" data-slide="prev">
	    <span class="glyphicon glyphicon-chevron-left"></span>
	  </a>
	  <a class="right carousel-control" href="#carousel-dino" role="button" data-slide="next">
	    <span class="glyphicon glyphicon-chevron-right"></span>
	  </a>
	</div>

	<!-- Insert script in here to get carousel to work!!!-->
	<script> $(function(){ $('.carousel').carousel( 'cycle');}); </script>
	<!--Carousel End-->


		<div id='slideshowText' class="col-md-7">
		...
		<div id='middle-left' class="col-md-5">
			<h2>Behind the Technology</h2>

			<p>
					The scientists at RAWR have taken the DNA smamples found from a 10,000 year old bone fragment found in the darkest depths of the Grand Canyon and were able to restore it. Combining the ancient DNA strands with reptile DNA we were able to reproduce the dinosuar population. We started with just humble beginnings and one dinosaur and turned it into an empire. Dinosaurs can now be seen roaming about everywhere. Get your pet dinosaur today!
			</p>
		</div>
