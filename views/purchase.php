<div id="store_div" class="row">
	<div class="col-md-6">
		 <h1 class="storeLabel" id="dinoStore">The Dino Store</h1>
	</div>
	<div class="col-md-6">
		<p>Welcome to our Dino Store where you can purchase your own dinosaur to bring home! Purchase one of our many dinosaure egg kits, adopt a dinosaur, buy accessories, and beyond. This comprehensive store has everything you need for a happy dinosaur online, delivered right to your door.</p>
	</div>
</div>
...
<div class="row">
	<div class="col-md-8">
		...
		<ul class="nav nav-tabs" role="tablist">
		  ...
		  <li><a href="#eggKits" role="tab" data-toggle="tab">Egg Kits</a></li>
		  <li><a href="#accessories" role="tab" data-toggle="tab">Accessories</a></li>
		  <li><a href="#nutrition" role="tab" data-toggle="tab">Nutrition</a></li>
		  <li><a href="#toys" role="tab" data-toggle="tab">Toys</a></li>
		  <li><a href="#bedding" role="tab" data-toggle="tab">Bedding</a></li>
		</ul>
		  ...
		  <div class="tab-pane active" id="adoption">
		  	<div class="col-md-12">
				<table class="storeItemTables">
		  				<tbody>
		  					<tr>
		  						<td><img src="../assets/images/Barosaurus.jpg" width="160px" height="140px" alt="Barosaurus"/></td>
		  						<td><img src="../assets/images/diceratops.jpg" width="160px" height="140px"/></td>
		  						<td><img src="../assets/images/erketu.jpg" width="160px" height="140px"/></td>
		  						<td><img src="../assets/images/giraffatitan.jpg" width="160px" height="140px"/></td>
		  					</tr>
		  					...
		  					<tr class="tableLowerRow">
		  						<td><img src="../assets/images/laosaurus.jpg" width="160px" height="140px"/></td>
		  						<td><img src="../assets/images/manidens.jpg" width="160px" height="140px"/></td>
		  						<td><img src="../assets/images/minmi.jpg" width="160px" height="140px"/></td>
		  					</tr>
		  					<tr class="tableLabelsForStore">
		  						<td>Laosaurus</td>
		  						<td>Manidens</td>
		  		...
		  		<div>
		  			...
		  			<table class="storeItemTables">
		  				<tbody>
		  					...
		  					<tr class="tableLabelsForStore">
		  						<td>Classic Bed</td>
		  						<td>Soft Round Bed</td>
		  						<td>Classic Square Bed</td>
		  						<td>Sofa Bed</td>
		  					</tr>
		  					<tr>
		  						<td>Price: $11.99</td>
		  					...
		  					<tr class="tableLabelsForStore">
		  						...
		  						<td>Wooden Bed w/Customized Name</td>
		  						<td>Couch Bed</td>
		  						<td>Luxury Bed</td>
		  					</tr>
		  					<tr>
		  					...
		  					<tr class="tableLabelsForStore">
		  						<td>Basic Gazebo</td>
		  						<td>Square Gazebo</td>
		  						<td>Enclosed Gazebo</td>
		  						<td>Classic Farm Shed</td>
		  					</tr>
		  					<tr>
		  						<td>Price: $199.99</td>
		  						<td>Price: $224.99</td>
